...
export class ReceivablesService extends BaseService {
  ...
  getAll(payload?: any): Observable<any[]> {
    const body = payload ?? {};
    return this.post<any>('Receivable/GetAll', body).pipe(
      map((res: any) => {
  ...
  create(payload: any): Observable<any> {
    return this.post<any>('Receivable/Create', payload);
  }

  override delete(id: string | number): Observable<any> {
    const body = { id } as any;
    return this.post<any>('Receivable/Delete', body);
  }
}
